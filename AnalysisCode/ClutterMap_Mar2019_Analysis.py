...
ClutterMap_Mar2019_Analysis.py
...
filedir = '../../../2.DataFiles/RawFiles/NexFiles/ClutterMap/';
filename = 'F190911_ClutterMap_Mar2019_recut.nex';
prevTime = 0.3;
numStims = 148;  
...
savedir = '../../../2.DataFiles/ProcessedFiles/ClutterMap/'
...
for j in np.arange(experiment['numNeurons']):
    plt.figure(figsize=(20/2.54,20/2.54),dpi=200);
    #plt.figure();
